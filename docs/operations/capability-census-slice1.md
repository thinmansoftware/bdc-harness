...
It inventories code-defined capabilities and reports their code-defined default flags. It
...
| --- | ---: | --- | --- | --- |
| `overseer.escalation` | 0 | off | `packages/overseer` | null |
| `overseer.repair` | 1 | off | `packages/overseer` | null |
| `overseer.branch` | 1 | off | `packages/overseer` | null |
| `overseer.lifecycle` | 1 | off | `packages/overseer` | null |
| `overseer.merge` | 1 | off | `packages/overseer` | null |
| `merge-manager.overseer-merge-manager-v1` | 1 | off | `packages/overseer` | null |
| `taskmaster.deliver_ruling` | n/a | on | `packages/server/src/taskmaster` | null |
| `taskmaster.nudge` | n/a | on | `packages/server/src/taskmaster` | null |
| `taskmaster.escalate_p0` | n/a | on | `packages/server/src/taskmaster` | null |
| `taskmaster.digest` | n/a | on | `packages/server/src/taskmaster` | null |
...
Taskmaster tiers are `n/a` because its action types have no entry in the tier registry.
