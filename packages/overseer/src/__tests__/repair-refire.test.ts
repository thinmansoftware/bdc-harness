...
function makeClaimDeps(): RepairRefireExecutionClaimDeps {
  return {
    acquire: mock(async input => ({
      ok: true as const,
      created: true,
      ...
      claim: {
        ...
        motion_file_path: 'overseer://test',
    ...
    complete: mock(async input => ({
      ...
      claim: {
        claim_id: input.claim_id,
        motion_id: 'overseer:test',
        action_kind: 'overseer_repair_refire',
        environment: 'recovery',
        target_sha: sha256hex('target'),
        action_key: sha256hex(input.claim_id),
        motion_file_path: 'overseer://test',
        motion_revision_sha: '0'.repeat(40),
        claimant_principal: input.actor_principal,
        claimant_xo_holder_id: 'recovery',
        ...
        effect_attempt_state: 'completed',
        effect_armed_at: '2026-07-16T00:00:00.000Z',
        acquired_at: '2026-07-16T00:00:00.000Z',
        renewed_at: null,
        expires_at: '2999-01-01T00:00:00.000Z',
        released_at: null,
    ...
    release: mock(async input => ({
      ...
      claim: {
        ...
        renewed_at: null,
        expires_at: '2999-01-01T00:00:00.000Z',
        released_at: '2026-07-16T00:00:01.000Z',
        completed_at: null,
        external_effect_reference: null,
        completion_evidence: null,
        reconciliation_evidence: null,
