...
export function createWorkflowStore(): IWorkflowStore {
  return {
    ...
    listPendingWorkflowRunsBefore: workflowDb.listPendingWorkflowRunsBefore,
    listStaleRunningWorkflowRunsBefore: workflowDb.listStaleRunningWorkflowRunsBefore,
    orphanPendingWorkflowRun: workflowDb.orphanPendingWorkflowRun,
    failStaleRunningWorkflowRun: workflowDb.failStaleRunningWorkflowRun,
    ...
    createDurableWorkflowEvent: workflowEventDb.createDurableWorkflowEvent,
